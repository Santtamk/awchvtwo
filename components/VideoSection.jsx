...
const VideoSection101 = () => {
  ...
  return (
    // <div className="w-full self-stretch py-12 px-5  inline-flex flex-row justify-center items-center gap-1 lg:gap-3 overflow-hidden lg:px-25 ">
    //   {/* Left arrow */}
    //   <button
    //     className="
    //      p-3.5 lg:p-5 bg-primary-800 rounded-full inline-flex flex-col justify-center items-center  overflow-hidden content-center cursor-pointer "
    //     onClick={handlePrev}
    //   >
