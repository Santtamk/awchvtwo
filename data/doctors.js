const doctors = [
  ...
  },
  {
    ...
    medicalEdu: "MBBS, Gold Medalist (Pathology, FMT), Sonology, Cosmetology",
    image: "/Doctors/neetu_singh.jpg",
    bio: {
      p1: "Dr. Neetu Singh is a highly respected medical professional with over 30 years of distinguished experience, recognized for her academic excellence with Gold Medals in Pathology, Forensic Medicine, and Toxicology (FMT). She has developed expertise in Sonology and Cosmetology, while also excelling in clinical care and hospital administration.",
      p2: "Her leadership journey includes serving as Ex-Deputy Chief Medical Officer at DVC Hospital and currently as the Medical Superintendent at Avishkar Women & Children Hospital. Through these roles, she has successfully combined clinical expertise with organizational leadership to advance healthcare delivery.",
      p3: "At the core of her philosophy lies a commitment to patient education, empathetic communication, and individualized treatment plans. She is a staunch advocate for her patients, integrating deep clinical knowledge with the latest medical innovations to ensure superior outcomes and holistic care.",
      p4: "",
    },
    language: ["English", "Hindi", "Bengali"],
    areasOfWork: [
